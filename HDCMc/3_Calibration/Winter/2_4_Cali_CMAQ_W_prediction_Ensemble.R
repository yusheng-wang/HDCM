...
ggsave(plot = p1, paste0(paste0("./figure/"), 'Fig7_Cali',
...
int <- 1e0
{
  ...
  CMAQ_Cali_PM25$Date <- paste0("Dec", " ", 
...
ggsave(plot = p1, paste0(paste0("./figure/"), 'FigS4_W_wts.ens',
...
ggsave(plot = p1, paste0(paste0("./figure/"), 'FigS5_W_sd.ens',
                         ".pdf"), dpi= 500, width  = 9, height = 2.5)
